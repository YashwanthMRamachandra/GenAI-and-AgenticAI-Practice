...
crypto_config = {
    "crypto_replace_ffx_fpe_config": {
        ...
        "common_alphabet": "NUMERIC",  # IMPORTANT (since digits)
    }
}
...
df_deid = pd.DataFrame(data, columns=df.columns)
df_deid.to_csv("output/output_deid.csv", index=False)

print("✅ De-ID completed")